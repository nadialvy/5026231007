...
<head>
  ...
  <link rel="stylesheet" href="sabrinaStyles.css" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&display=swap"
    rel="stylesheet" />
  <link href="https://fonts.googleapis.com/css2?family=Rubik:wght@100;300;400;500;700;900&display=swap"
    rel="stylesheet" />
...
<body>
  <section class="position-relative overflow-hidden">
    <video autoplay muted loop class="position-absolute w-100 h-100" style="object-fit: cover">
      <source
        src="https://ugc.production.linktr.ee/d6147b14-8d17-4aac-a764-a45b7227bd0c_Sabrina-Carpenter-Custom-Background-Mobile.mp4?io=true&size=background-profile-v1_0"
        type="video/mp4" />
      Browser Anda tidak mendukung tag video.
    </video>
    <div
      class="position-relative px-2 flex-column z-index-1 d-flex justify-content-center align-items-start mx-auto py-5"
      style="max-width: 580px; margin: auto">
      <!-- setting button -->
      <div id="settingButton" class="d-flex justify-content-center align-items-center rounded-circle" style="
            top: 16px;
            width: 40px;
            height: 40px;
            position: fixed;
            z-index: 999;
          ">
        <img src="./assets/sabrina-carpenter/icon/kebab-menu.svg" alt="kebab"
          style="width: 10px; height: 10px; transform: rotate(90deg)" />
      </div>

      <div class="d-flex flex-column w-100 justify-content-center align-items-center">
        <!-- profile section -->
        <div class="d-flex flex-column justify-content-center align-items-center" data-aos="zoom-in-up">
          <img
            src="https://ugc.production.linktr.ee/6585a260-8be1-40eb-8aca-37f0b6bcfd08_1-Front.jpeg?io=true&size=avatar-v3_0"
            alt="profile pict" class="rounded-circle mb-3" style="width: 96px; height: 96px" />
          <div class="d-flex justify-content-center align-items-center">
            <p class="text-center mb-0 mr-2 font-weight-bold" style="font-size: 20px">
              Sabrina Carpenter
            </p>
            <img
          ...
          <p class="font-weight-light text-center">
            Short n’ Sweet Deluxe Pre-Order💋
          </p>
        </div>

        <!-- social media section -->
        <div class="d-flex flex-wrap justify-content-center align-items-center my-2 gap-wrap">
          <a href="https://www.instagram.com/sabrinacarpenter" target="_blank" data-aos="fade-up"
            class="social-media-scale-animation transform">
            <div class="social-media-scale-animation">
          ...
          <a href="https://tiktok.com/@sabrinacarpenter" target="_blank" class="mx-3" data-aos="fade-up"
            data-aos-delay="50">
            <div class="social-media-scale-animation">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 50 50">
                <path
          ...
          <a href="https://www.facebook.com/sabrinacarpenter" target="_blank" data-aos="fade-up" data-aos-delay="100">
            <div class="social-media-scale-animation">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 50 50">
                <path
          ...
          <a href="https://www.facebook.com/sabrinacarpenter" target="_blank" class="mx-3" data-aos="fade-up"
            data-aos-delay="150">
            <div class="social-media-scale-animation">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 50 50">
                <path
          ...
          <a href="https://x.com/sabrinaannlynn" target="_blank" data-aos="fade-up" data-aos-delay="200">
            <div class="social-media-scale-animation">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="36" height="36" viewBox="0 0 50 50">
                <path
        ...
        <!--nav section -->
        <nav id="stopNav" class="d-flex my-4 align-items-center justify-content-between"
          style="background-color: #efeeea; border-radius: 100px" data-aos="zoom-out">
          <div id="navLinks" class="d-flex justify-content-center align-items-center" style="
                background-color: black;
                border-radius: 100px;
                padding: 10px 32px;
              ">
            <p class="text-white m-0">Links</p>
          </div>
          <div id="navShop" class="d-flex justify-content-center align-items-center" style="
      ...
      <!-- LINKS NAV CONTENT -->
      <div class="w-100" style="display: block" id="navLinksContent">
        <!-- music and video section -->
        <div class="d-flex flex-column w-100 align-items-start justify-content-start">
          <p class="font-weight-bold text-center w-100" data-aos="fade-up">
            Music & Videos
          </p>

          <!-- first card -->
          <a href="https://sabrinacarpenter.lnk.to/ShortnSweetDeluxe" target="_blank">
            <div class="position-relative w-100" style="aspect-ratio: 16/9; height: auto" data-aos="fade-left"
              data-aos-delay="100">
              <div class="position-relative" style="top: 0; left: 0; position: relative; z-index: 10">
                <img
                  src="https://ugc.production.linktr.ee/9c5d47e1-9709-4a02-8a18-2e1203f405e2_SNS-DELUXE-COVER.jpeg?io=true&size=thumbnail-feature-v1_0"
                  alt="sabrina carpenter" style="
                      max-width: 100%;
                      height: auto;
                      border-radius: 24px;
                      position: relative;
                ...
                <div class="position-absolute d-flex justify-content-between align-items-center"
                  style="bottom: 24px; left: 24px; z-index: 2; width: 92%">
                  <p class="text-white m-0">Short n' Sweet (Deluxe)</p>
                  <img src="./assets/sabrina-carpenter/icon/kebab-menu.svg" alt="kebab menu"
          ...
          <!-- second card with embedded youtube -->
          <div class="position-relative w-100" style="aspect-ratio: 16/9; height: auto; margin-top: 4%"
            data-aos="fade-right">
            <!-- Thumbnail with Playable Video -->
            <div class="position-relative" style="padding-top: 3%; border-radius: 24px; overflow: hidden">
              <iframe width="620" height="315" src="https://www.youtube.com/embed/YiQ7qiL73aI?si=Okjtgy2LJbjqnXKH"
                ...
                referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="
                  ...
                  "></iframe>
              <img
                src="https://ugc.production.linktr.ee/f7e85f6d-ec2e-41a3-aaf6-0076a52892e6_maxresdefault.jpeg?io=true&size=thumbnail-feature-v1_0"
                alt="video thumbnail" style="
                    position: relative;
                    top: 0%;
                    left: 0;
                    width: 100%;
                  ...
                  " />
              <div class="position-absolute d-flex justify-content-between align-items-center"
                style="bottom: 24px; left: 24px; z-index: 3; width: 92%">
          ...
          <!-- third card -->
          <div class="d-flex w-100 flex-column" data-aos="fade-left">
            <p class="text-center mt-5 mx-auto font-weight-bold">
              Short n' Sweet Tour
            </p>
            <a href="https://sabrinacarpenter.lnk.to/OfficialTour" target="_blank">
              <div class="position-relative w-100" style="aspect-ratio: 16/9; height: auto">
                <div class="position-relative interactive-card" style="top: 0; left: 0; z-index: 10">
                  <img
                    src="https://ugc.production.linktr.ee/3b448bd1-2cb8-4b9b-aa3d-0c51164b7e72_Photo-Jan-25-2018--5-38-50-PM.jpeg?io=true&size=thumbnail-feature-v1_0"
                    alt="sabrina carpenter" style="
                        width: 100%;
                        height: auto;
                        border-radius: 24px;
          ...
          <!-- take action button -->
          <a href="https://propeller.la/leaders/26125/sabrina-carpenter" target="_blank" class="w-100">
            <div class="position-relative w-100" style="margin-top: 7%" data-aos="zoom-in-down">
              <div style="
                  ...
                  "
                class="position-relative interactive-card d-flex justify-content-between py-2 px-3 align-items-center">
                <img
                  src="https://ugc.production.linktr.ee/4b446a4d-a645-4264-8b84-645ec88bd742_IMG-5882.jpeg?io=true&size=thumbnail-stack-v1_0"
                  alt="thumbnail propeller" class="rounded-circle" style="width: 46px; height: 46px" />
                <p class="m-0" style="color: black">
                  Take Action With Propeller
                </p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                  style="width: 16px; height: 16px" />
              </div>
              <div class="position-absolute w-100 h-100" style="
                    top: 6px;
        ...
        <!-- merch section -->
        <div class="w-100">
          <p class="font-weight-bold text-center w-100" style="margin-top: 7%" data-aos="fade-up" data-aos-delay="200">
            Merch
          </p>
          <a href="https://store.sabrinacarpenter.com/" target="_blank" class="w-100">
            <div class="position-relative w-100" data-aos="fade-right" data-aos-delay="300">
              <div style="
                    background-color: #90b2ca;
                    border-radius: 100px;
                    z-index: 2;
                ...
                class="position-relative interactive-card d-flex justify-content-between py-2 px-3 align-items-center">
                <img
                  src="https://ugc.production.linktr.ee/484e3b6c-9628-4bb0-98b4-66c64a153e49_sc-sns-share-2-28058236-a84f-4fda-a184-d6d192aa78c1.png?io=true&size=thumbnail-stack-v1_0"
                  alt="thumbnail propeller" class="rounded-circle" style="width: 46px; height: 46px" />
                <p class="m-0" style="color: black">
                  Sabrina Carpenter Official Store
                </p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                  style="width: 16px; height: 16px" />
              </div>
          ...
          <div class="position-relative w-100" style="margin-top: 5%" data-aos="fade-left" data-aos-delay="300">
            <div class="d-flex flex-column w-100 position-relative p-4" style="
                  background-color: #90b2ca;
                  border-radius: 24px;
                  z-index: 2;
                ">
              <div class="d-flex mb-3 justify-content-between align-items-center">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
                  class="absolute left-[20px] top-[20px]" role="img" aria-hidden="false"
                  aria-labelledby="ltclid29128_title ">
                  <title id="ltclid29128_title">Shop</title>
                  <path
                ...
                <p class="m-0">Short n' Sweet Merch</p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                  style="width: 16px; height: 16px" />
              </div>
              <div class="w-100 position-relative" style="scroll-behavior: smooth; overflow: hidden">
                <div class="merch-items d-flex position-relative">
                  <a href="https://store.sabrinacarpenter.com/products/please-please-please-remix-crew" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/FD24C9B4-7F98-4B42-B538-29C301BC8B92.png?v=1739462490"
                          alt="merch" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center rubik-text truncate-2-lines font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          please please please remix crew - Sabrina Carpenter
                          Official Store
                        </p>
                        <p class="w-100 text-center rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          $65
                        </p>
                      </div>
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/short-n-sweet-tights" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/PRODUCT_SAB_SNSTIGHTS_01.png?v=1739462487"
                          alt="merch" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          short n' sweet tights - Sabrina Carpenter Official
                          Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/short-n-sweet-mug" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/PRODUCT_SAB_SNSRIBBONMUG_01.png?v=1739462484"
                          alt="merch mug" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          short n' sweet mug - Sabrina Carpenter Official
                          Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/busy-woman-hat" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/busy_woman_hat_front.png?v=1739462498"
                          alt="merch hat" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          busy woman hat - Sabrina Carpenter Official Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          $35
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/short-n-sweet-deluxe-d2c-exclusive-2lp"
                    target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/Shortn_Sweet_Deluxe_D2CExclusive2LP.png?v=1738687605"
                          alt="baju hoodie" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          Short n' Sweet (Deluxe) D2C Exclusive 2LP - Sabrina
                          Carpenter Official Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          $45.99
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/short-n-sweet-deluxe-2lp" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img
                          src="https://store.sabrinacarpenter.com/cdn/shop/files/Shortn_Sweet_Deluxe_2LP.png?v=1738687644"
                          alt="baju hoodie" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          Short n' Sweet (Deluxe) 2LP - Sabrina Carpenter
                          Official Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                  ...
                  <a href="https://store.sabrinacarpenter.com/products/short-n-sweet-playing-cards" target="_blank">
                    <div class="merch-item px-2">
                      <div class="d-flex flex-column align-items-center justify-content-center"
                        style="max-width: 160px">
                        <img src="https://store.sabrinacarpenter.com/cdn/shop/files/cards.png?v=1738687441"
                          alt="baju hoodie" style="width: 200px; height: auto" class="mb-1" />
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
                          short n' sweet playing cards - Sabrina Carpenter
                          Official Store
                        </p>
                        <p class="w-100 text-center truncate-2-lines rubik-text font-weight-bold m-0"
                          style="font-size: 12px; color: black">
              ...
              <!-- Navigation buttons -->
              <button class="rounded-circle p-2 nav-btn prev-btn" style="
                    position: absolute;
                    top: 50%;
                    ...
                    outline: none;
                  ">
                <img src="./assets/sabrina-carpenter/icon/chevron-right.svg" alt="chevron left"
                  style="width: 32px; height: 32px" />
              </button>

              <button class="rounded-circle p-2 nav-btn next-btn" style="
                    position: absolute;
                    top: 50%;
                    ...
                    outline: none;
                  ">
                <img src="./assets/sabrina-carpenter/icon/chevron-right.svg" alt="chevron right"
                  style="width: 32px; height: 32px" />
              </button>
            </div>
            <div class="position-absolute w-100 h-100" style="
        ...
        <div class="d-flex justify-content-center align-items-center w-100 flex-column">
          <p class="mx-auto font-weight-bold" style="margin-top: 7%" data-aos="fade-up">
            Links
          </p>
          <a href="https://laylo.com/teamsabrina/" target="_blank" class="w-100">
            <div class="position-relative w-100" data-aos="zoom-in-up" data-aos-delay="100">
              <div style="
                    background-color: #90b2ca;
                    border-radius: 100px;
                    z-index: 2;
                ...
                class="position-relative interactive-card d-flex justify-content-between py-2 px-3 align-items-center">
                <img
                  src="https://ugc.production.linktr.ee/a6d341f7-e11a-4254-9d3c-0361f2fd054a_general.jpeg?io=true&size=thumbnail-stack-v1_0"
                  alt="thumbnail store" class="rounded-circle" style="width: 46px; height: 46px" />
                <p class="m-0" style="color: black">Team Sabrina 🩵</p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                  style="width: 16px; height: 16px" />
              </div>
          ...
          <a href="https://www.sabrinacarpenter.com/" target="_blank" class="w-100">
            <div class="position-relative w-100" style="margin-top: 4%; margin-bottom: 4%" data-aos="zoom-in-up"
              data-aos-delay="150">
              <div style="
                    background-color: #90b2ca;
                    border-radius: 100px;
                ...
                class="position-relative interactive-card d-flex justify-content-between py-2 px-3 align-items-center">
                <img
                  src="https://ugc.production.linktr.ee/906ed067-2cc4-4329-b6fb-173a961a6f15_Screenshot-2024-06-04-at-11.11.07-AM.png?io=true&size=thumbnail-stack-v1_0"
                  alt="thumbnail store" class="rounded-circle" style="width: 46px; height: 46px" />
                <p class="m-0" style="color: black">Official Website</p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                  style="width: 16px; height: 16px" />
              </div>
              <div class="position-absolute w-100 h-100" style="
          ...
          <div class="position-relative w-100 mb-5" data-aos="zoom-in-up" data-aos-delay="200">
            <div style="
                  background-color: #90b2ca;
                  border-radius: 100px;
                  z-index: 2;
              ...
              class="position-relative interactive-card d-flex justify-content-between py-2 px-3 align-items-center">
              <img
                src="https://ugc.production.linktr.ee/6c11225f-0d9c-45e0-8221-1c1a6d43da2b_Screenshot-2024-06-05-at-12.56.52-PM.png?io=true&size=thumbnail-stack-v1_0"
                alt="thumbnail store" class="rounded-circle" style="width: 46px; height: 46px" />
              <p class="m-0" style="color: black">Join E-mailing List</p>
              <img src="./assets/sabrina-carpenter/icon/kebab-menu-gray.svg" alt="kebab menu"
                style="width: 16px; height: 16px" />
            </div>
            <div class="position-absolute w-100 h-100" style="
      ...
      <!-- SHOP NAV CONTENT -->
      <div class="w-100" style="display: none" id="navShopContent">
        <a href="https://store.sabrinacarpenter.com/collections/all-merch" target="_blank" class="w-100">
          <div class="position-relative w-100" style="margin-top: 7%" data-aos="zoom-in-down">
            <div style="
                  background-color: #90b2ca;
                  border-radius: 32px;
                  ...
                  border: 2px solid black;
                "
              class="position-relative interactive-card d-flex flex-column justify-content-center p-3 align-items-center">
              <img
                src="https://ugc.production.linktr.ee/e1220bac-dc3c-4b6f-a495-79cad0ef4f88_sc-sns-share-2-28058236-a84f-4fda-a184-d6d192aa78c1.png?io=true&size=square-fit"
                alt="all merch" style="
                    width: 150px;
                    height: 150px;
                    object-fit: cover;
                    border-radius: 16px;
                  " />
              <div class="w-100 d-flex justify-content-between aliign-items-center">
                <div></div>
                <p style="font-size: 14px; color: black" class="mt-3">
                  All Merch - Sabrina Carpenter Official Store
                </p>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu.svg" alt="kebab menu"
        ...
        <a href="https://store.sabrinacarpenter.com/collections/all-merch" target="_blank" class="w-100">
          <div class="position-relative w-100" style="margin-top: 4%" data-aos="zoom-in-down">
            <div style="
                  background-color: #90b2ca;
                  border-radius: 32px;
                  z-index: 2;
              ...
              <div class="container">
                <div class="row">
                  <div class="col d-flex justify-content-center align-items-center" style="
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/299b3866-be23-446f-a48f-03bec6a92d94_snscd.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto; margin: auto" />
                  </div>
                  <div class="col d-flex justify-content-center align-items-center" style="
                        margin-left: 4%;
                        margin-right: 4%;
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/675a2b33-ca6d-4bb8-a3bf-5da4af852187_Shortn-Sweet-Deluxe-2LP.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto" />
                  </div>
                  <div class="col d-flex justify-content-center align-items-center" style="
                        background-color: white;
                        border-radius: 16px;
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/35a1d56a-2e7a-4b68-abaf-9b4738ca34b1_Shortn-Sweet-Deluxe-D2CExclusive2LP.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto" />
                  </div>
                </div>
              </div>
              <div class="w-100 d-flex justify-content-between align-items-end">
                ...
                <div class="d-flex flex-column justify-content-center align-items-center mt-3">
                  <p style="font-size: 14px; color: black" class="font-weight-bold m-0">
                    Music Collection
                  </p>
                  <p style="font-size: 12px; color: rgb(88, 88, 88)" class="m-0">
                    20 Products
                  </p>
                </div>
                <img src="./assets/sabrina-carpenter/icon/kebab-menu.svg" alt="kebab menu"
              ...
              <div class="container">
                <div class="row">
                  <div class="col d-flex justify-content-center align-items-center" style="
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/71db444a-51ab-4d8c-b8e9-64cb58dbf46b_image.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto; margin: auto" />
                  </div>
                  <div class="col d-flex justify-content-center align-items-center" style="
                        margin-left: 4%;
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/13cd740e-2257-4d63-9e23-ad0216f76604_image.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto" />
                  </div>
                  <div class="col d-flex justify-content-center align-items-center" style="
                        background-color: white;
                      ...
                      ">
                    <img
                      src="https://ugc.production.linktr.ee/0b301055-7622-4b15-aa0f-989f50028f9c_image.png?io=true&size=square-fit"
                      alt="img1" class="img-fluid" style="width: 160px; height: auto" />
                  </div>
                </div>
              </div>
        ...
        <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_campaign=footer_logo_cta&utm_content=sabrinacarpenter"
          target="_blank" data-aos="zoom-in-up" data-aos-delay="250" style="margin: auto" class="d-block mt-5 w-75">
          <div class="px-4 shadow py-3 d-flex justify-content-between align-items-center" style="
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 25" height="16px"
              style="display: block; width: auto; margin-right: 4px">
            ...
            <p style="color: black; margin: auto">
              Join sabrinacarpenter on Linktree
            </p>
          </div>
        </a>
      ...
      <a href="https://linktr.ee/?utm_source=linktree&utm_medium=profile&utm_campaign=footer_logo_cta&utm_content=sabrinacarpenter"
        target="_blank" data-aos="zoom-in-up" data-aos-delay="250" style="margin: auto">
        <div class="px-4 shadow py-3 d-flex justify-content-between align-items-center" style="
              background-color: rgba(255, 255, 255, 0.524);
              margin: auto;
              width: 100%;
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const navShopContent = document.getElementById("navShopContent");

    navLinks.addEventListener("click", function() {
      navLinks.style.backgroundColor = "black";
      navLinks.querySelector("p").style.color = "white";
      navShop.style.backgroundColor = "#efeeea";
      navShop.querySelector("p").style.color = "black";

      navShopContent.style.display = "none";
      navLinksContent.style.display = "block";
    });

    navShop.addEventListener("click", function() {
      navShop.style.backgroundColor = "black";
      navShop.querySelector("p").style.color = "white";
      navLinks.style.backgroundColor = "#efeeea";
      navLinks.querySelector("p").style.color = "black";
      navLinksContent.style.display = "none";
      navShopContent.style.display = "block";
    });

    // === Merch Scroll Logic ===
    const wrapper = document.querySelector(".merch-items");
    ...
    function updateButtons() {
      ...
      nextBtn.style.display =
        currentPosition > maxPosition ? "block" : "none";
    }
    ...
    // === Sticky Setting Button Scroll Stop ===
    const button = document.getElementById("settingButton");
    const stopPoint = document.getElementById("stopNav");

    function handleScroll() {
      const navTop = stopPoint.getBoundingClientRect().top;
      const buttonHeight = button.offsetHeight;

      if (navTop <= buttonHeight + 16) {
        // Fade out only
